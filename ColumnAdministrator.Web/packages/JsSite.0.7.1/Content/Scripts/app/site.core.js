...
var bootstrapper = function () {
    ...
    var root = this,
        ...
        initGlobalization = function () {
            ...
            window.ko.validation.rules.number.validator = function (value, validate) {
                    //return !(value) || (validate && !isNaN(window.moment(value)));
                return !(value) || (validate && !isNaN(Globalize.parseFloat(value)));
            };

            window.ko.validation.rules.date.validator = function (value, validate) {
//                return !(value) || (validate && moment(value).format('DD.MM.YYYY') != null);
                return !(value) || (validate && window.Globalize.parseDate(value) != null);
            };

            // устанавливаем Jquery Validations

            $.validator.methods.date = function (value, element) {
                //if (moment(value)) {
                if (window.Globalize.parseDate(value)) {
                    return true;
                }
                return false;
            };
        ...
        initConfig = function () {
            ...
            // indicator
            site.cfg.busyIndicatorImageName = '/images/preloader-w8-cycle-black.gif';
